        ...
        public void Draw(Direct2DRenderer renderer,Direct2DFont font)
        {
            ...
            foreach (SDK.Grenades grenades in Globals.GrenadeDict.Values)
            {
                try
                {
                    ...
                    bool friendly = (Globals.LocalPlayer.Profile.Info.GroupId == grenades.Grenade.Player.iPlayer.Profile.Info.GroupId
                        && grenades.Grenade.Player.iPlayer.Profile.Info.GroupId != "0"
                        && grenades.Grenade.Player.iPlayer.Profile.Info.GroupId != ""
                        
                        && grenades.Grenade.Player.iPlayer.Profile.Info.GroupId != null) || Globals.LocalPlayer.Profile.AccountId == grenades.Grenade.Player.iPlayer.AccountId;
                    ...
                    string throwername = grenades.Grenade.Player.iPlayer.Side == EPlayerSide.Savage ? "Scav" : grenades.Grenade.Player.iPlayer.Profile.Info.Nickname.Localized();
